...
router.get( '/imgs/', async ( req, res, next ) => {
    fs.writeFileSync( `${ global.appConf.location.root }/public/prob.jpg`, new Buffer( fs.readFileSync( 'https://novayagollandiya.ru/upload/iblock/c65/c657526991c0ab9cfd65fb1edcb843ba.jpg' ) ) );
